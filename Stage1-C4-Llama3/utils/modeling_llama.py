...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        # Handle symbolic tensor sizes by converting to concrete values
        try:
            bsz, q_len, _ = hidden_states.size()
        except RuntimeError as e:
            if "symbolic sizes" in str(e):
                bsz, q_len, _ = hidden_states.shape  # Fallback: use shape instead of size()
