...
try:   # Standard & Third-party Optimizers
    from opentome.optimizer import (
        ...
        MuonSGDMom, MuonNSOnly, MuonNSLRScale,
        MuonC1b, MuonC2b, MuonC3b, MuonC4b,
        MuonOldScale, MuonS4, MuonBest,
        MuonS1, MuonS3, MuonS5,
        MuonC1c, MuonC2c,
    )
    ...
    **Note**
    ...
    # Standard & Third-party Optimizers
        ...
        optimizer_kwargs.update({
            "betas": (beta1, beta2),
            "eps": eps,
            "max_grad_norm": 0,   # train loop already calls clip_grad_norm_; disable internal clip to avoid double clipping
        })
    elif name == "Shampoo":
        ...
        optimizer_kwargs.update({
            "betas": (beta1, beta2),
            "eps": eps,
            "rank": int(os.environ.get("CONDA_RANK", "256")),
            "update_proj_gap": int(os.environ.get("CONDA_UPDATE_PROJ_GAP", "2000")),
            "scale": float(os.environ.get("CONDA_SCALE", "0.25")),
            "proj_type": os.environ.get("CONDA_PROJ_TYPE", "std"),
        })
    ...
    if standard_optimizers_available:
        standard_optimizer_classes = {
            ...
            "MuonSGDMom": MuonSGDMom, "MuonNSOnly": MuonNSOnly, "MuonNSLRScale": MuonNSLRScale,
            "MuonC2b": MuonC2b, "MuonC3b": MuonC3b, "MuonC4b": MuonC4b,
            "MuonS1": MuonS1, "MuonS3": MuonS3, "MuonS5": MuonS5,
            "MuonC1c": MuonC1c, "MuonC2c": MuonC2c,
